...
//		mailInfo.setMailServerPort("25");   		//qq：587   163：25  
//		mailInfo.setValidate(true);
//		mailInfo.setUserName("z314108271@163.com");
//		//mailInfo.setPassword("feyjeslivvnrbghd");	// 我的qq第三方授权密码
//		mailInfo.setPassword("cheng1314");			// 我的163第三方授权密码
//		mailInfo.setFromAddress("z314108271@163.com");
//		mailInfo.setToAddress("314108271@qq.com");
...
//		// sms.sendHtmlMail(mailInfo);//发送html格式
		...
		mailInfo.setValidate(true);
		mailInfo.setUserName("zhoubincheng@gzgtx.com");
		mailInfo.setPassword("4HvAc8an3uJ2sZTt");	
		mailInfo.setFromAddress("zhoubincheng@gzgtx.com");
		mailInfo.setToAddress("314108271@qq.com");
		mailInfo.setSubject("设置邮件标题");
		mailInfo.setContent("设置邮件内容");
		sms.sendTextMail(mailInfo);//发送文体格式
