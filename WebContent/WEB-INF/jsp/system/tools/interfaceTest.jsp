			...
			<div class="widget-body">
			 ...
			 <div class="widget-main">
					...
					<div class="step-content row-fluid position-relative">
						...
						<label style="float:left;padding-left: 5px;margin-top: -5px;"><input name="S_TYPE_S" id="S_TYPE_S" style="width:79px;" type="text" value="KEYDATA" title="例子"></label>
					</div>
					<div class="step-content row-fluid position-relative">
						<div style="float: left;">
							<span class="input-icon">
								<input type="text" id="serverUrl" title="输入请求地址" value="<%=basePath%>/login_login?KEYDATA='gzgtx123admin,gtx,1gzgtx123,gtx,2121'" style="width:540px;">
					...
					<div class="step-content row-fluid position-relative">
						<ul class="unstyled spaced2">
							...
							<li class="text-warning green"><i class="icon-star blue"></i>
								校验加密规则：(取其中一个参数名+当前日期[格式 20180405]+混淆码",mbfw," 然后md5加密 的值作为 参数FKEY的值提交)
							</li>
						</ul>
					</div>
